...
exports.getUID = exports.deleteAccount = exports.changePassword = exports.updateProfile = exports.getProfile = exports.checkVerificationStatus = exports.resendVerificationEmail = exports.login = exports.verifyEmail = exports.register = void 0;
const bcrypt_1 = __importDefault(require("bcrypt"));
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const crypto_1 = __importDefault(require("crypto"));
const sendEmail_1 = require("../utils/sendEmail");
const prismaClient_1 = __importDefault(require("../utils/prismaClient"));
const testdb = prismaClient_1.default;
...
const getUID = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { email } = req.query;
    if (!email || typeof email !== 'string') {
        return res.status(400).json({ error: 'Invalid Parameter' });
    }
    console.log(testdb === prismaClient_1.default);
    const user = yield testdb.user.findFirst({
        where: { email: email }
    });
    ...
    res.json({ id: user === null || user === void 0 ? void 0 : user.id, token: user === null || user === void 0 ? void 0 : user.verificationToken });
});
