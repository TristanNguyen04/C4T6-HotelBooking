            ...
            {hasMoreAmenities && (
                <div className="mt-4 text-center">
                    <button
                        ...
                        className="px-4 py-2 text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-lg transition-colors duration-200 font-medium"
                    >
                        {showAll ? 'Show Less' : `Show More (${filteredAmenities.length - 10} more)`}
                    </button>
                </div>
            )}
        </div>
