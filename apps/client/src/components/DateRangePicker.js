...
export default function DateRangePicker({ dateRange, onChange, isOpen, onToggle, minDate }) {
    ...
    return (_jsxs("div", { className: "relative w-full", children: [_jsx("div", { onClick: onToggle, "data-cy": "stay-period-toggle", className: `w-full rounded-lg border border-gray-300 text-sm cursor-pointer bg-white 
