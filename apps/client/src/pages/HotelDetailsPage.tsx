  ...
  <section className="flex-1 space-y-6">
    ...
    <div className="space-y-6">
      {[1, 2, 3, 4].map((_, i) => (
        <div
          key={i}
          className="flex bg-white rounded-md shadow-sm overflow-hidden hover:shadow-md transition"
        >
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <div className="flex gap-2 mt-1 flex-wrap text-xs">
                  <span className="bg-green-100 text-green-700 px-2 py-0.5 rounded">Free WiFi</span>
                  <span className="bg-blue-100 text-blue-700 px-2 py-0.5 rounded">Spa</span>
